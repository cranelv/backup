...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new Matrix contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around an Matrix contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Caller is an auto generated read-only Go binding around an Matrix contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around an Matrix contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around an Matrix contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an Matrix contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an Matrix contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an Matrix contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around an Matrix contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around an Matrix contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around an Matrix contract.
...
import org.matrix.gman.*;
import org.matrix.gman.internal.*;
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		// Matrix address where this contract is located at.
		public final Address Address;

		// Matrix transaction in which this contract was deployed (if known!).
