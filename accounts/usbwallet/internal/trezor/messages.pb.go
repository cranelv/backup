...
const (
	...
	MessageType_MessageType_MatrixGetAddress       MessageType = 56
	MessageType_MessageType_MatrixAddress          MessageType = 57
	MessageType_MessageType_MatrixSignTx           MessageType = 58
	MessageType_MessageType_MatrixTxRequest        MessageType = 59
	MessageType_MessageType_MatrixTxAck            MessageType = 60
	...
	MessageType_MessageType_MatrixSignMessage      MessageType = 64
	MessageType_MessageType_MatrixVerifyMessage    MessageType = 65
	MessageType_MessageType_MatrixMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_MatrixGetAddress",
	57:  "MessageType_MatrixAddress",
	58:  "MessageType_MatrixSignTx",
	59:  "MessageType_MatrixTxRequest",
	60:  "MessageType_MatrixTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_MatrixSignMessage",
	65:  "MessageType_MatrixVerifyMessage",
	66:  "MessageType_MatrixMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_MatrixGetAddress":       56,
	"MessageType_MatrixAddress":          57,
	"MessageType_MatrixSignTx":           58,
	"MessageType_MatrixTxRequest":        59,
	"MessageType_MatrixTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_MatrixSignMessage":      64,
	"MessageType_MatrixVerifyMessage":    65,
	"MessageType_MatrixMessageSignature": 66,
...
// *
// Request: Ask device for Matrix address corresponding to address_n path
// @next PassphraseRequest
// @next MatrixAddress
// @next Failure
type MatrixGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *MatrixGetAddress) Reset()                    { *m = MatrixGetAddress{} }
func (m *MatrixGetAddress) String() string            { return proto.CompactTextString(m) }
func (*MatrixGetAddress) ProtoMessage()               {}
func (*MatrixGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *MatrixGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MatrixGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Matrix address derived from device private seed
// @prev MatrixGetAddress
type MatrixAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MatrixAddress) Reset()                    { *m = MatrixAddress{} }
func (m *MatrixAddress) String() string            { return proto.CompactTextString(m) }
func (*MatrixAddress) ProtoMessage()               {}
func (*MatrixAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *MatrixAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next MatrixTxRequest
// @next Failure
type MatrixSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *MatrixSignTx) Reset()                    { *m = MatrixSignTx{} }
func (m *MatrixSignTx) String() string            { return proto.CompactTextString(m) }
func (*MatrixSignTx) ProtoMessage()               {}
func (*MatrixSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *MatrixSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MatrixSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *MatrixSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *MatrixSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *MatrixSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *MatrixSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *MatrixSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *MatrixSignTx) GetDataLength() uint32 {
...
func (m *MatrixSignTx) GetChainId() uint32 {
...
func (m *MatrixTxRequest) Reset()                    { *m = MatrixTxRequest{} }
func (m *MatrixTxRequest) String() string            { return proto.CompactTextString(m) }
func (*MatrixTxRequest) ProtoMessage()               {}
func (*MatrixTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *MatrixTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *MatrixTxRequest) GetSignatureV() uint32 {
...
func (m *MatrixTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *MatrixTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev MatrixTxRequest
// @next MatrixTxRequest
type MatrixTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MatrixTxAck) Reset()                    { *m = MatrixTxAck{} }
func (m *MatrixTxAck) String() string            { return proto.CompactTextString(m) }
func (*MatrixTxAck) ProtoMessage()               {}
func (*MatrixTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *MatrixTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next MatrixMessageSignature
// @next Failure
type MatrixSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *MatrixSignMessage) Reset()                    { *m = MatrixSignMessage{} }
func (m *MatrixSignMessage) String() string            { return proto.CompactTextString(m) }
func (*MatrixSignMessage) ProtoMessage()               {}
func (*MatrixSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *MatrixSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *MatrixSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type MatrixVerifyMessage struct {
...
func (m *MatrixVerifyMessage) Reset()                    { *m = MatrixVerifyMessage{} }
func (m *MatrixVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*MatrixVerifyMessage) ProtoMessage()               {}
func (*MatrixVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *MatrixVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *MatrixVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *MatrixVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev MatrixSignMessage
type MatrixMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *MatrixMessageSignature) Reset()                    { *m = MatrixMessageSignature{} }
func (m *MatrixMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*MatrixMessageSignature) ProtoMessage()               {}
func (*MatrixMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *MatrixMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *MatrixMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MatrixGetAddress)(nil), "MatrixGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*MatrixAddress)(nil), "MatrixAddress")
	...
	proto.RegisterType((*MatrixSignTx)(nil), "MatrixSignTx")
	proto.RegisterType((*MatrixTxRequest)(nil), "MatrixTxRequest")
	proto.RegisterType((*MatrixTxAck)(nil), "MatrixTxAck")
	proto.RegisterType((*MatrixSignMessage)(nil), "MatrixSignMessage")
	proto.RegisterType((*MatrixVerifyMessage)(nil), "MatrixVerifyMessage")
	proto.RegisterType((*MatrixMessageSignature)(nil), "MatrixMessageSignature")
