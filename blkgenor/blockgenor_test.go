...
//			So(p.state, ShouldEqual, StateHeaderGen)
//			So(p.role, ShouldEqual, common.RoleValidator)
//		})
//		Convey("高度0，当前身份为广播节点", func() {
//
//			blockgen, err := New(eth)
//			if err != nil {
//			}
//			roleMsg := &mc.RoleUpdatedMsg{common.RoleBroadcast, uint64(0), common.HexToAddress(testAddress)}
//			blockgen.roleUpdatedMsgHandle(roleMsg)
//			p := blockgen.pm.GetCurrentProcess()
//			So(blockgen.pm.curNumber, ShouldEqual, 1)
...
//		})
//
//		Convey("高度0，当前身份为其它节点", func() {
//
//			blockgen, err := New(eth)
//			if err != nil {
//			}
//			roleMsg := &mc.RoleUpdatedMsg{common.RoleMiner, uint64(0), common.HexToAddress(testAddress)}
//			blockgen.roleUpdatedMsgHandle(roleMsg)
//			So(blockgen.pm.curNumber, ShouldEqual, 1)
//			_, ok := blockgen.pm.processMap[0]
//			So(ok, ShouldBeFalse)
//
//		})
//
//		Convey("高度广播高度，当前身份为广播节点", func() {
//
//			blockgen, err := New(eth)
//			if err != nil {
//			}
//			roleMsg := &mc.RoleUpdatedMsg{common.RoleBroadcast, common.GetBroadcastInterval(), common.HexToAddress(testAddress)}
//			blockgen.roleUpdatedMsgHandle(roleMsg)
//			So(blockgen.pm.curNumber, ShouldEqual, common.GetBroadcastInterval()+1)
//			curProcess := blockgen.pm.GetCurrentProcess()
//			So(curProcess.number, ShouldEqual, common.GetBroadcastInterval()+1)
...
//		Convey("未收到高度1的ca消息，当前节点是高度1的leader", func() {
//			blockgen, err := New(eth)
//			if err != nil {
//			}
//			//roleMsg := &mc.RoleUpdatedMsg{common.RoleValidator, uint64(0), common.HexToAddress(testAddress)}
...
//			})
//			//blockgen.roleUpdatedMsgHandle(roleMsg)
//			leaderMsg := &mc.LeaderChangeNotify{true, common.HexToAddress(testAddress), common.HexToAddress(testAddress1), 1, 0}
...
//		})
//
//		Convey("未收到高度1的ca消息，当前节点是高度1的next leader", func() {
//			blockgen, err := New(eth)
//			if err != nil {
//			}
//			//roleMsg := &mc.RoleUpdatedMsg{common.RoleValidator, uint64(0), common.HexToAddress(testAddress)}
...
//			})
//			//blockgen.roleUpdatedMsgHandle(roleMsg)
//			leaderMsg := &mc.LeaderChangeNotify{true, common.HexToAddress(testAddress1), common.HexToAddress(testAddress), 1, 0}
//			blockgen.leaderChangeNotifyHandle(leaderMsg)
//			process, ok := blockgen.pm.processMap[1]
//			So(ok, ShouldBeTrue)
//			So(process.number, ShouldEqual, 1)
...
//			})
//			//blockgen.roleUpdatedMsgHandle(roleMsg)
//			leaderMsg := &mc.LeaderChangeNotify{false, common.HexToAddress(testAddress1), common.HexToAddress(testAddress), 1, 0}
//			blockgen.leaderChangeNotifyHandle(leaderMsg)
//			process, ok := blockgen.pm.processMap[1]
//			So(ok, ShouldBeTrue)
//			So(process.number, ShouldEqual, 1)
...
//			fromlist := []common.Address{common.HexToAddress(testAddress), common.HexToAddress(testAddress1), common.HexToAddress(testAddress2), common.HexToAddress(testAddress3)}
//			minerResults := make([]*mc.HD_MiningRspMsg, 0)
//			roleMsg := &mc.RoleUpdatedMsg{common.RoleValidator, uint64(Number), common.HexToAddress(testAddress)}
//			blockgen.roleUpdatedMsgHandle(roleMsg)
//			for i := 0; i < len(fromlist); i++ {
//				tempResult := &mc.HD_MiningRspMsg{fromlist[i], Number, blockhash, diff, types.EncodeNonce(uint64(0)), from, common.Hash{0x01}, Signatures}
//				minerResults = append(minerResults, tempResult)
...
//			fromlist := []common.Address{common.HexToAddress(testAddress), common.HexToAddress(testAddress1), common.HexToAddress(testAddress2), common.HexToAddress(testAddress3)}
//			roleMsg := &mc.RoleUpdatedMsg{common.RoleValidator, uint64(Number - 1), common.HexToAddress(testAddress)}
//			blockgen.roleUpdatedMsgHandle(roleMsg)
//
//			broadcastResult := &mc.HD_BroadcastMiningRspMsg{fromlist[0], &mc.BlockData{newheader, nil}}
//			var guard *monkey.PatchGuard
//			guard = monkey.Patch(ca.GetAccountOriginalRole, func(account common.Address, number uint64) (common.RoleType, error) {
//				guard.Unpatch()
//				defer guard.Restore()
...
//			}
//			header := eth.BlockChain().CurrentHeader()
//			Number := uint64(common.GetBroadcastInterval() - 2)
//			newheader := types.CopyHeader(header)
...
//			})
//			blockgen.broadcastMinerResultHandle(broadcastResult)
//			leaderMsg := &mc.LeaderChangeNotify{true, common.HexToAddress(testAddress1), common.HexToAddress(testAddress), Number + 1, 0}
//			blockgen.leaderChangeNotifyHandle(leaderMsg)
//
//			p, ok := blockgen.pm.processMap[Number+1]
//			So(ok, ShouldBeTrue)
...
//
//		Convey("本地共识结果测试高度1,矿工挖坑结果高度1，本地高度0", func() {
//			blockgen, err := New(eth)
//			if err != nil {
//			}
//			currentNum := uint64(0)
...
//			roleMsg := &mc.RoleUpdatedMsg{common.RoleValidator, currentNum, common.HexToAddress(testAddress)}
//			blockgen.roleUpdatedMsgHandle(roleMsg)
//			leaderMsg := &mc.LeaderChangeNotify{true, common.HexToAddress(testAddress), common.HexToAddress(testAddress1), currentNum + 1, 0}
//			blockgen.leaderChangeNotifyHandle(leaderMsg)
//			blockhash := common.Hash{0x01}
//			diff := big.NewInt(100)
//			from := common.HexToAddress(testAddress)
