...
!define GROUPNAME "Matrix"
!define APPNAME "Gman"
!define DESCRIPTION "Official Go implementation of the Matrix protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gman is installed global
