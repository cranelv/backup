...
func (manash *Ethash) Author(header *types.Header) (common.Address, error) {
	return header.Coinbase, nil
}

// VerifyHeader checks whether a header conforms to the consensus rules of the
// stock Matrix manash engine.
func (manash *Ethash) VerifyHeader(chain consensus.ChainReader, header *types.Header, seal bool) error {
...
// VerifyHeader checks whether a header conforms to the consensus rules of the
// stock Matrix manash engine.
func (manash *Ethash) VerifySignatures(signature []common.Signature) (bool, error) {
	// If we're running a full engine faking, accept any input as valid
	return true, nil
}
...
func (manash *Ethash) VerifyHeaders(chain consensus.ChainReader, headers []*types.Header, seals []bool) (chan<- struct{}, <-chan error) {
	// If we're running a full engine faking, accept any input as valid
...
func (manash *Ethash) verifyHeaderWorker(chain consensus.ChainReader, headers []*types.Header, seals []bool, index int) error {
...
func (manash *Ethash) VerifyUncles(chain consensus.ChainReader, block *types.Block) error {
	// If we're running a full engine faking, accept any input as valid
	if manash.config.PowMode == ModeFullFake {
		return nil
	}
...
func (manash *Ethash) verifyHeader(chain consensus.ChainReader, header, parent *types.Header, uncle bool, seal bool) error {
...
func (manash *Ethash) CalcDifficulty(chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
...
func (manash *Ethash) VerifySeal(chain consensus.ChainReader, header *types.Header) error {
...
func (manash *Ethash) Prepare(chain consensus.ChainReader, header *types.Header) error {
...
func (manash *Ethash) Finalize(chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt) (*types.Block, error) {
