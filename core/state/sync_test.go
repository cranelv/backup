...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(mandb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db mandb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db mandb.Database, root common.Hash) error {
...
func checkStateConsistency(db mandb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, mandb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(mandb.Database), srcRoot)
