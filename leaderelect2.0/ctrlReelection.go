...
func (self *controller) handleRLReq(req *mc.HD_V2_ReelectLeaderReqMsg) {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectVote, rsp, common.Address{},common.RoleNil, []common.Address{req.InquiryReq.From})
}
...
func (self *controller) sendInquiryReq() {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectInquiryReq, req,common.Address{}, common.RoleValidator, nil)
	return
}
...
func (self *controller) sendInquiryReqToSingle(target common.Address) {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectInquiryReq, req,common.Address{}, common.RoleNil, []common.Address{target})
...
func (self *controller) sendInquiryRspWithPOS(reqHash common.Hash, target common.Address, number uint64) {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectInquiryRsp, rsp,common.Address{}, common.RoleNil, []common.Address{target})
}
...
func (self *controller) sendRLReq() {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectReq, req,common.Address{}, common.RoleValidator, nil)
}
...
func (self *controller) sendResultBroadcastMsg() {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectBroadcast, msg,common.Address{}, common.RoleValidator, nil)
}
...
func (self *controller) sendResultBroadcastRsp(req *mc.HD_V2_ReelectBroadcastMsg) {
	...
	self.matrix.HD().SendNodeMsg(mc.HD_V2_LeaderReelectBroadcastRsp, rsp,common.Address{}, common.RoleNil, []common.Address{req.From})
}
