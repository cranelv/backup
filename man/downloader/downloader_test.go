...
type downloadTester struct {
	...
	stateDb mandb.Database // Database used by the tester for syncing from peers
	peerDb  mandb.Database // Database of the peers containing all data
...
func (dl *downloadTester) makeChain(n int, seed byte, parent *types.Block, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]*types.Header, map[common.Hash]*types.Block, map[common.Hash]types.Receipts) {
	...
	blocks, receipts := core.GenerateChain(params.TestChainConfig, parent, manash.NewFaker(), dl.peerDb, n, func(i int, block *core.BlockGen) {
