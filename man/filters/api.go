...
// information related to the Matrix protocol such als blocks, transactions and logs.
...
// Same as matrix.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria matrix.FilterQuery
