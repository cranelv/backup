...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gman.ipc", false, filepath.Join(os.TempDir(), "gman.ipc")},
		{"data", "gman.ipc", false, "data/gman.ipc"},
		{"data", "./gman.ipc", false, "./gman.ipc"},
		{"data", "/gman.ipc", false, "/gman.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gman.ipc", true, `\\.\pipe\gman.ipc`},
		{"data", "gman.ipc", true, `\\.\pipe\gman.ipc`},
		{"data", `\\.\pipe\gman.ipc`, true, `\\.\pipe\gman.ipc`},
	}
