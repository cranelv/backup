...
type SetRewardsExec interface {
	...
	SetMinerOutRewards(reward *big.Int, state util.StateDB, num uint64) map[common.Address]*big.Int
...
func (str *DefaultSetRewards) SetMinerOutRewards(reward *big.Int, state util.StateDB, num uint64) map[common.Address]*big.Int {

	return str.miner.SetMinerOutRewards(reward, state, num)
}
