...
func (ic *interest) canPayInterest(state vm.StateDB, num uint64, payInterestPeriod uint64) bool {
...
func (ic *interest) SetReward(InterestMap map[common.Address]*big.Int, state vm.StateDB) {
