...
func (br *BlockReward) getValidatorRewards(blockReward *big.Int, Leader common.Address, num uint64) map[common.Address]*big.Int {
	...
	electReward := br.rewardCfg.SetReward.GetSelectedRewards(electedMount, br.chain, common.RoleValidator|common.RoleBackupValidator, num, br.rewardCfg.RewardMount.RewardRate.BackupRewardRate)
...
func (br *BlockReward) getMinerRewards(blockReward *big.Int, num uint64) map[common.Address]*big.Int {
	...
	electReward := br.rewardCfg.SetReward.GetSelectedRewards(electedMount, br.chain, common.RoleMiner|common.RoleBackupMiner, num, br.rewardCfg.RewardMount.RewardRate.BackupRewardRate)
	foundationReward := br.calcFoundationRewards(FoundationsMount, num)
