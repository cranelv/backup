...
// See https://github.com/MatrixAINetwork/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) Run(subtest StateSubtest, vmconfig vm.Config) (*state.StateDB, error) {
	...
	context := core.NewEVMContext(msg.From(), msg.GasPrice(), block.Header(), nil, &t.json.Env.Coinbase)
...
func MakePreState(db mandb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/MatrixAINetwork/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
